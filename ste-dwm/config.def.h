...
static const Key keys[] = {
	...
	{MODKEY, XK_b, spawn, SHCMD("__NV_PRIME_RENDER_OFFLOAD=1 __GLX_VENDOR_LIBRARY_NAME=nvidia __VK_LAYER_NV_optimus=NVIDIA_only firefox")},
	...
	// kill dwm
	{MODKEY | ControlMask, XK_q, spawn, SHCMD("killall bar.sh ste-dwm")},
	...
	{MODKEY | Mod1Mask, XK_h, hidewin, {0}},
	{MODKEY | Mod1Mask, XK_u, restorewin, {0}},
